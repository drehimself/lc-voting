            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <select name="category_id" id="category_id"
                            ...
                            <option value="{{ $row->id }}" {{ $row->id==$challenge->category_id ? 'selected':'' }}>
                                {{ $row->name }}</option>
                            @empty
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" name="old_file" value="{{ $challenge->files }}">
                    </div>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('description') is-invalid @enderror" name="description"
                            id="" cols="30" rows="10">{{ $challenge->description }}</textarea>
                        @error('description')
                        <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
